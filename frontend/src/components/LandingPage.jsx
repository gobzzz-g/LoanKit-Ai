                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className={`font-medium ${customer.creditScore >= 750 ? 'text-success-600' :
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <span className={`text-xs font-medium px-2 py-1 rounded-full ${customer.scenario === 'Instant Approval' ? 'bg-success-100 text-success-700' :
